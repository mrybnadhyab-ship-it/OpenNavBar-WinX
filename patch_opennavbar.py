...
#    Fullscreen must never hide OpenNavBar.
#    Do not change Win-X hiding or original Swipe/Reveal behavior.
# ============================================================
...
if "WINX_FULLSCREEN_STABLE_PATCH" not in code:
    ...
    if fullscreen_expr in code:
        code = code.replace(fullscreen_expr, fullscreen_replacement)
    else:
        print("Warning: hide_on_fullscreen preference not found; fullscreen behavior left unchanged")
