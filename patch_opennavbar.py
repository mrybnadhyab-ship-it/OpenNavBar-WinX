...
if "WINX_CLOCK_LAYOUT_PATCH" not in code:
    ...
    clock_layout_patch = r'''
        ...
        //
        // IMPORTANT:
        // The old version scanned EVERY PIXEL of the PNG
        // using getPixel(), then created a cropped bitmap.
        //
        // That expensive operation has been completely removed.
        //
        // The exact supplied PNG is decoded and displayed directly.
        // No pixel scan.
        // No bitmap cropping.
        // No createBitmap().
        //
...
print("Microsoft: NO PIXEL SCANNING")
print("Microsoft: NO BITMAP CROPPING")
print("Microsoft: NO createBitmap()")
