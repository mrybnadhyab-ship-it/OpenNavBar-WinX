...
if len(sys.argv) != 2:
    print("Usage: python3 patch_opennavbar.py 
<NavigationOverlayService.kt>")
    sys.exit(1)
...
print("Clock: 9sp time / 9sp date / vertical-safe layout / non-touch")
