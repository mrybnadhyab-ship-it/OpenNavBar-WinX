...
#    Portrait = overlay must stay visible.
#    Landscape = original fullscreen behavior remains untouched.
# ============================================================

if "WINX_PORTRAIT_FULLSCREEN_FIX" not in code:

    # Protect the existing fullscreen-hide condition.
    old = 'if (prefs.getBoolean("hide_on_fullscreen", true))'
    ...
    # Add marker even if the exact original condition was absent,
    # preventing repeated patching.
    marker = r'''
...
'''
    ...
    code = code[:match.end()] + marker + code[match.end():]
...
# ============================================================
# 7. INSERT CLOCK WITHOUT REPLACING THE ORIGINAL BUTTON LAYOUT
# ============================================================
...
print("================================================")
print(" OPENNAVBAR WIN X + CLOCK + PORTRAIT FIX")
print("================================================")
print("")
print("Win X package:")
print(WINX_PACKAGE)
...
print("Portrait: fullscreen will NOT hide OpenNavBar")
print("Landscape: original fullscreen behavior preserved")
