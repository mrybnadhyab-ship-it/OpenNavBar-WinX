...
# ============================================================
# 8.9 EMBED EXACT ADOBE IMAGE
# ============================================================
#
# IMPORTANT:
#
# The transparent border is removed HERE during the build.
#
# This means:
#
# - NO getPixel() inside Android
# - NO pixel scanning inside Android
# - NO Bitmap.createBitmap() inside Android
# - NO runtime cropping
#
# Pillow performs the crop once in GitHub Actions.
# The resulting cropped PNG is then converted to Base64
# and embedded directly into the APK.
#
# ============================================================
...
try:
    ...
    with Image.open(icon_path) as original_image:
    ...
    raise RuntimeError(
        "Failed to crop transparent Microsoft icon: "
        + str(e)
    )
...
print("Clock: existing design preserved")
print("Gmail: ORIGINAL CUSTOM EMBEDDED ICON")
print("Gmail: 16dp icon")
print("Microsoft: EXACT Adobe_20230903_191353.png")
print("Microsoft: transparent margins removed at BUILD TIME")
print("Microsoft: NO runtime pixel scanning")
print("Microsoft: NO runtime bitmap cropping")
print("Microsoft: NO runtime createBitmap()")
print("Microsoft: 15dp icon area")
print("Microsoft: 40dp button slot")
print("Swipe: ORIGINAL SWIPE/REVEAL CODE PRESERVED")
print("Button order:")
print("Back | Home | Microsoft | Gmail | SPACE | Clock | Recent")
print("================================================")
