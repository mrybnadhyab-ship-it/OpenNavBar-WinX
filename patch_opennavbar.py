...
if "WINX_CLOCK_LAYOUT_PATCH" not in code:
    ...
    clock_layout_patch = r'''
        ...
        val winXMicrosoftButton = android.widget.FrameLayout(this).apply {
            ...
            // 20% larger than the old 16dp icon: 19.2dp, rounded to 19dp.
            addView(
                microsoftIcon,
                android.widget.FrameLayout.LayoutParams(
                    dpToPx(19),
        ...
        if (shouldSwap) {
            container.addView(winXGmailButton, 2)
            container.addView(winXSpacer, 3)
            container.addView(winXMicrosoftButton, 4)
        } else {
            // Back | Home | Microsoft | Gmail | SPACE | Clock | Recent
            container.addView(winXMicrosoftButton, 2)
            container.addView(winXGmailButton, 3)
            container.addView(winXSpacer, 4)
        }
...
print("Microsoft: EXACT Adobe_20230903_191353.png / 20% larger icon")
