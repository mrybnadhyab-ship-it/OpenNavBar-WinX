...
if "WINX_CLOCK_LAYOUT_PATCH" not in code:
    ...
    clock_layout_patch = r'''
        ...
        val winXMicrosoftStoreButton = android.widget.FrameLayout(this).apply {
            ...
            // Move Microsoft Store slightly toward Home without changing layout order.
            translationX = if (shouldSwap) dpToPx(4).toFloat() else -dpToPx(4).toFloat()
        ...
        // shouldSwap: Recent | Clock | SPACE | Gmail | Store | Home | Back
        // normal:    Back | Home | Store | Gmail | SPACE | Clock | Recent
        if (shouldSwap) {
